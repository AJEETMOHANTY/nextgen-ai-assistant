...
# st.session_state -> dict -> this dictionary will not be cleared when the page is rerun, so we can use it to store the conversation history.
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        ai_message = st.write_stream(message_chunk.content for message_chunk,metadata in
            chatbot.stream(
